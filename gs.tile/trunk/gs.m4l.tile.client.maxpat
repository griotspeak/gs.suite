{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 265.0, 97.0, 1325.0, 863.0 ],
		"bglocked" : 0,
		"defrect" : [ 265.0, 97.0, 1325.0, 863.0 ],
		"openrect" : [ 0.0, 0.0, 240.0, 169.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 136.0, 589.0, 122.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-46",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "contrast_frame",
					"patching_rect" : [ 107.0, 501.0, 91.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-44",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "live.colors",
					"patching_rect" : [ 107.0, 537.0, 64.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 2,
					"id" : "obj-41",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.0, 708.0, 5.0, 100.0 ],
					"presentation" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 854.0, 299.0, 409.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"id" : "obj-35",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"id" : "obj-20",
					"presentation_rect" : [ 5.0, 0.0, 218.0, 149.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 588.0, 450.0, 241.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 3,
					"id" : "obj-31",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 379.0, 490.5, 116.5, 490.5 ]
				}
